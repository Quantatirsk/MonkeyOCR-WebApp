...
class FileHandler:
    ...
    def get_original_file(
        ...
        if filename:
            ...
            original_file_path = task_uploads_dir / filename
            return str(
                original_file_path) if original_file_path.exists() else None
        else:
    ...
    async def process_result_zip(
        ...
        try:
            ...
            markdown_content = self._fix_markdown_image_paths(
    ...
    def _generate_metadata(
        ...
        # You might want to parse the actual metadata from MonkeyOCR if
        # available
